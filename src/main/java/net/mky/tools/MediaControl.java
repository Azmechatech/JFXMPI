...
public class MediaControl extends BorderPane {
    ...
    //private final Image PlayButtonImage = new Image(MediaControl.class.getResourceAsStream("playbutton.png"));
    //private final Image PauseButtonImage = new Image(MediaControl.class.getResourceAsStream("pausebutton.png"));
    ...
    public MediaControl(final MediaPlayer mp) {
        ...
        playButton.minWidth(Control.USE_PREF_SIZE);
        ...
        captureButton.minWidth(Control.USE_PREF_SIZE);
        captureButton.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent e) {
                WritableImage image = mediaView.snapshot(new SnapshotParameters(), null);

                File file = new File(mp.getMedia().getSource().substring(6) + "_" + mp.getCurrentTime().toMillis() + ".png");
        ...
        mediaBar.getChildren().add(captureButton);
        // Time label
